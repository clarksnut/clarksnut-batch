...
git push "https://$username:$password@github.com/clarksnut/clarksnut-mail-collector.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/clarksnut/clarksnut-mail-collector.git" --tags
