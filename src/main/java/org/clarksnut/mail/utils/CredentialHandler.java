...
public class CredentialHandler implements MethodInterceptor {
    ...
    public Object intercept(Object o, Method method, Object[] args, MethodProxy methodProxy) throws Throwable {
        if (method.getName().equals("initialize")) {
            ...
            KeycloakBrokerHttpInterceptor interceptor = new KeycloakBrokerHttpInterceptor(keycloakDeployment.getAuthServerBaseUrl(), keycloakDeployment.getRealm(), broker, credential);
